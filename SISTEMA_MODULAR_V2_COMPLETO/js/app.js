...
class NovaLuzApp {
    ...
    async loadPrestamos() {
        try {
            ...
            this.showError('Error en préstamos: ' + error.message);
        }
    }
    ...
    async loadPagos() {
        try {
            ...
            this.showError('Error en pagos: ' + error.message);
        }
    }
    ...
    async loadMora() {
        try {
            ...
            this.showError('Error en mora: ' + error.message);
        }
    }
    ...
    async loadReportes() {
        try {
            ...
            this.showError('Error en reportes: ' + error.message);
        }
    }
    ...
    async loadConfiguracion() {
        try {
            ...
            this.showError('Error en configuración: ' + error.message);
        }
    }
