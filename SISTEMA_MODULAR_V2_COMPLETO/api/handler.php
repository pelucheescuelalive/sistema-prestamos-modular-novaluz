...
// Incluir configuración y módulos usando BASE_PATH
require_once BASE_PATH . '/config/app.php';
require_once BASE_PATH . '/config/database.php';
require_once BASE_PATH . '/modules/ClienteModular.php';
require_once BASE_PATH . '/modules/PrestamoModular.php';
require_once BASE_PATH . '/modules/PagoModular.php';
require_once BASE_PATH . '/modules/MoraModular.php';
...
try {
    // Inicializar módulos
    $clienteModular = new ClienteNuevo();
    ...
    switch ($action) {
        // =============== CLIENTES ===============
        case 'crear_cliente':
            $resultado = $clienteModular->crear($input);
