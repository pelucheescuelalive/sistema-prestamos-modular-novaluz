    ...
    <main class="main-content">
        ...
        <div id="vista-nuevo-cliente" class="vista">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                ...
                <button class="btn btn-secondary" onclick="showTab('clientes')">
                    ← Volver a Clientes
                </button>
            </div>
        ...
        <div id="vista-nuevo-prestamo" class="vista">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h2>➕ Crear Nuevo Préstamo</h2>
                <button class="btn btn-secondary" onclick="showTab('prestamos')">
                    ← Volver a Préstamos
                </button>
            </div>
            <div id="form-nuevo-prestamo">
                <div class="loading">🔄 Cargando formulario...</div>
            </div>
        </div>
